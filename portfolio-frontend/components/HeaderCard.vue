<template>
  <header
    class="lg:h-full lg:min-w-[40%] lg:flex-shrink-0 lg:overflow-hidden lg:py-12"
  >
    ...
    >
      ...
      >
        <div v-if="!mobileMenuOpen" class="flex min-w-0 items-center gap-3">
          <img
    ...
    >
      <div
        ...
        class="bg-primary-bg1/95 fixed top-16 right-0 left-0 z-40 max-h-[33vh] overflow-y-auto backdrop-blur-lg lg:hidden"
      >
        <div class="flex gap-6 px-6 py-4">
          ...
          <div class="flex flex-1 flex-col items-center">
            ...
            <p class="text-fg-muted text-center text-xs leading-relaxed">
              Start-up mindset — shipping fast, iterating on product, and
              building scalable processes for high-performing engineering teams.
            </p>
          </div>
